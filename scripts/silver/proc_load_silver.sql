...
Script Purpose:
	...
	- Cleaning the data in bronze schema, including transform and handle missing values.
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			CAST(
				...
				AS DATE
			) AS prd_end_date -- Calculate the end date as one day before the next start date
	...
	BEGIN CATCH
		PRINT '============================================================'
		PRINT 'ERROR OCCURING DURING LOADING SILVER LAYER'
